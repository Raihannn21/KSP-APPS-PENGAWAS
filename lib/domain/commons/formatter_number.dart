...
class FormatterNumber {
  static String getPriceDisplay(String productPrice) {
    final idrFormatter = CurrencyFormat(
      symbol: 'Rp',
      thousandSeparator: '.',
      decimalSeparator: ',',
    );

    return CurrencyFormatter.format(productPrice, idrFormatter, decimal: 0);
  ...
  static String getPriceDisplayTwoZero(double productPrice) {
    ...
    return CurrencyFormatter.format(productPrice, idrFormatter);
    // FlutterMoneyFormatter fmf = new FlutterMoneyFormatter(
    //     amount: productPrice,
    //     settings: MoneyFormatterSettings(
    //       symbol: 'Rp',
  ...
  static String getPriceOnly(String productPrice) {
    final idrFormatter = CurrencyFormat(
      symbol: '',
      thousandSeparator: '.',
      decimalSeparator: ',',
  ...
  static String getPriceDisplayRounded(double productPrice) {
    ...
    return CurrencyFormatter.format(priceRender, idrFormatter, decimal: 0);
