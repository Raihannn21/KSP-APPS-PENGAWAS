...
class FormatterDate {
  ...
  ///  Method for checking if created at and status stay in waiting payment > 55 Seconds
  /// return false if < 55 Seconds
  /// return true if > 55 Seconds
  /// */
  static bool divideFiftyFiveSeconds(String dates) {
    //55 Seconds
    const dividerInMs = 55000;
